...
const AppSettingsSchema = CollectionSchema(
  ...
  properties: {
    r'fontSize': PropertySchema(
      ...
      enumMap: _AppSettingsfontSizeEnumValueMap,
    ),
...
int _appSettingsEstimateSize(
  ...
  bytesCount += 3 + object.fontSize.name.length * 3;
...
void _appSettingsSerialize(
  ...
  writer.writeString(offsets[0], object.fontSize.name);
...
AppSettings _appSettingsDeserialize(
  ...
  object.fontSize =
      _AppSettingsfontSizeValueEnumMap[reader.readStringOrNull(offsets[0])] ??
          AppFontSize.small;
  object.id = id;
  object.language =
      _AppSettingslanguageValueEnumMap[reader.readStringOrNull(offsets[1])] ??
          AppLanguage.vi;
  object.themeMode =
      _AppSettingsthemeModeValueEnumMap[reader.readStringOrNull(offsets[2])] ??
          AppThemeMode.light;
  return object;
}
...
P _appSettingsDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (_AppSettingsfontSizeValueEnumMap[
              reader.readStringOrNull(offset)] ??
          AppFontSize.small) as P;
    case 1:
...
const _AppSettingsfontSizeEnumValueMap = {
  r'small': r'small',
  r'medium': r'medium',
  r'large': r'large',
  r'extraLarge': r'extraLarge',
};
const _AppSettingsfontSizeValueEnumMap = {
  r'small': AppFontSize.small,
  r'medium': AppFontSize.medium,
  r'large': AppFontSize.large,
  r'extraLarge': AppFontSize.extraLarge,
};
...
extension AppSettingsQueryFilter
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterFilterCondition> fontSizeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, AppFontSize, QQueryOperations> fontSizeProperty() {
    return QueryBuilder.apply(this, (query) {
