...
class ShoppingRepositoryImpl implements ShoppingRepository {
  ...
  Future<void> addRecipe(int recipeId, {int servings = 1}) async {
    await dio.post(
      '/v1/shopping/add',
      queryParameters: {'recipeId': recipeId, 'servings': servings},
    );
  }
  ...
  Future<void> togglePurchased(List<int> ingredientIds, bool purchased) async {
    await dio.put(
      '/v1/shopping/ingredient/purchased',
      queryParameters: {'ingredientIds': ingredientIds, 'purchased': purchased},
    );
  }
}
